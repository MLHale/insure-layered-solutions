...
- Successfully code a [Python script](https://github.com/MLHale/insure-layered-solutions/tree/master/python) to extract desired data from the National Vulnerability Database and US Cert Database.
